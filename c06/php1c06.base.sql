...
-- Volcando datos para la tabla php1g10.agenda: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla php1g10.agenda_log: ~2 rows (aproximadamente)
...
-- Volcando estructura para vista php1g10.vgenda
...
DROP TABLE IF EXISTS `vgenda`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vgenda` AS SELECT id, upper(CONCAT_WS(' ',paterno,materno,nombre)) persona,fnacimiento ,
